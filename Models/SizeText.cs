...
// Compact byte label for list-row captions (previously duplicated in the two
// settings-candidate models). SaveValidation.FormatBytes stays separate: the
// status-bar lines use its one-decimal "0.0" style.
